module Spree
  class Gateway::Bogus < Gateway
    TEST_VISA = %w(4111111111111111 4012888888881881 4222222222222)
    TEST_MC   = %w(5500000000000004 5555555555554444 5105105105105100)
    TEST_AMEX = %w(378282246310005 371449635398431 378734493671000 340000000000009)
    TEST_DISC = %w(6011000000000004 6011111111111117 6011000990139424)
