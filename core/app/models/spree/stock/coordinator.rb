module Spree
  module Stock
    class Coordinator
      ...
      def build_location_configured_packages
        order.order_stock_locations.where(shipment_fulfilled: false).group_by(&:stock_location).flat_map do |stock_location, stock_location_configurations|
