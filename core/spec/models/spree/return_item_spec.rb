...
describe Spree::ReturnItem, type: :model do
  ...
  describe "#attempt_accept" do
    ...
    (all_acceptance_statuses - %w(accepted pending)).each do |invalid_transition_status|
  ...
  describe "#reject" do
    ...
    (all_acceptance_statuses - %w(accepted pending manual_intervention_required)).each do |invalid_transition_status|
      context "return_item has an acceptance status of #{invalid_transition_status}" do
