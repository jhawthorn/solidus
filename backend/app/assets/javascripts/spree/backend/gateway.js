Spree.ready(function() {
  ...
  render = function() {
    var gateway_type, preference_source;
    gateway_type = $gateway_type.val();
    preference_source = $preference_source.val();
    $(".js-preference-source-wrapper").toggle(
      gateway_type === original_gtwy_type
    );
    if (
      gateway_type === original_gtwy_type &&
      preference_source === original_preference_source
    ) {
      $(".js-gateway-settings").show();
      return $(".js-gateway-settings-warning").hide();
    } else {
      $(".js-gateway-settings").hide();
      return $(".js-gateway-settings-warning").show();
    }
  };
